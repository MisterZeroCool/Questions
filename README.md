...
- [Android components](#android-components)
   - [Q1a](#q1a) Какие компоненты андроид системы вы знаете? 
...
+ `BroadcastReceivers`
+ `ContentProviders`
Каждый из них объявляется в андроид манифесте и может являться точкой входа в приложение.
...
### Q34a
### Как ресурсы хранятся приложение?
